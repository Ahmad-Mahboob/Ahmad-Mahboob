...
projects.forEach((project) => {
  projectsContainer.insertAdjacentHTML('beforeend', `<div
            data-aos="fade-up"
            data-aos-once="true"
            class="project relative w-88 h-96 sm:w-96 sm:h-96 md:w-96 md:h-96 lg:w-112 lg:h-112 xl:w-128 xl:h-128 2xl:w-140 2xl:h-140 bg-white text-[#475569] dark:bg-[#1E293B] dark:text-gray-100 shadow-lg shadow-gray-600 pb-2 m-2 lg:m-4 rounded-sm transform transition-transform duration-300 hover:scale-105"
          >
            ...
            <div class="info p-1.5 flex flex-col justify-between px-3">
              <div>
                ...
                <span
                  class="project-desc block max-h-24 overflow-auto xl:text-xl relative custom-scrollbar dark:text-[#F8FAFC]"
                  data-full="${project.description}"
                >
                  <!-- Don't put the full description or substring here -->
                </span>
                <button class="toggle-btn cursor-pointer mt-2 text-sm text-blue-600 dark:text-[#3B82F6] hover:underline focus:outline-none block">
                  Read More
                </button>
              </div>
            ...
            <div class="btns absolute bottom-3 right-3 flex gap-2 justify-center">
                
                <button
                  class="px-2 py-1 lg:py-1 lg:px-3 xl:py-3 xl:px-4 2xl:py-4 2xl:px-6 bg-blue-600 dark:bg-[#3B82F6] rounded-md text-gray-100 transform transition-transform duration-300 hover:scale-105"
                >
                ...
                <button
                  class="px-2 py-1 lg:py-1 lg:px-3 xl:py-3 xl:px-4 2xl:py-4 2xl:px-6 bg-[#06B6D4] rounded-md text-gray-100 transform transition-transform duration-300 hover:scale-105"
                >
